...
files = {'file': open(r"C:\Users\hamma\OneDrive\Documents\Sound recordings\record_2.wav", 'rb')}
values = {"name": "hello", "format": ".wav"}
print(files)
print(values)
r = requests.post("http://3.95.255.194:8090/api/file", files=files, data=values)
print(r.text)
